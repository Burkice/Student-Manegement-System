        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Discount_Student_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Student",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstallmentC = table.Column<int>(type: "int", nullable: false),
                    Installmentt = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Installment_Period_PeriodId",
                        column: x => x.PeriodId,
                        principalTable: "Period",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Installment_Student_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Student",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Course_Period_PeriodId",
                        column: x => x.PeriodId,
                        principalTable: "Period",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
         ...
         constraints: table =>
         {
             ...
             table.ForeignKey(
                 ...
                 onDelete: ReferentialAction.Cascade);
             table.ForeignKey(
                 name: "FK_PaymentHistory_Period_PeriodId",
                 column: x => x.PeriodId,
                 principalTable: "Period",
                 principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Installment_PeriodId",
                table: "Installment",
                column: "PeriodId");

            migrationBuilder.CreateIndex(
                name: "IX_Installment_StudentId",
                table: "Installment",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentHistory_InstallmentId",
                table: "PaymentHistory",
                column: "InstallmentId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentHistory_PeriodId",
                table: "PaymentHistory",
                column: "PeriodId");
